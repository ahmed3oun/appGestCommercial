...
if(isset($_POST['btn-edit'])) {
    ...
    if (!$error) {
        $sql = "UPDATE products SET name='$name', category='$category' , quantity='$quantity',price='$price',description='$description',image='$image' WHERE id='$id';";
        if (mysqli_query($conn, $sql)) {
            $succesMsg = 'Updated succesfully';
            sleep(2);
            header('location:consultProduct.php');
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" method="post" action="editProduct.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $row['name'];?>"name="name" id="name" placeholder="Enter Your Product Name" />
                                                <span class="text-danger" ><br><?php if (isset($errorName)) echo $errorName;?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <!--<input type="" class="form-control" value="<?php echo $row['category'];?>"name="category" id="category"   placeholder="Enter Your Product Category" />-->
                                                <select id="category" class="form-control" name="category" value="<?php echo $row['category'];?>" >
                                                ...
                                                <span class="text-danger" ><br><?php if (isset($errorCategory)) echo $errorCategory;?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" value="<?php echo $row['quantity'];?>"name="quantity" id="quantity" placeholder="Enter Your Product Quantity" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="number" required="true" class="form-control" value="<?php echo $row['price'];?>" name="price" id="price" placeholder="Enter Your Product Price" />
                                                <input type="hidden" name="edit_id" value="<?php echo $id;?>">
                                                <span class="text-danger" ><br><?php if (isset($errorPrice)) echo $errorPrice;?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="textarea" required class="form-control" value="<?php echo $row['description'];?>" name="description" id="description" placeholder="Enter Your Product Description" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="file" required class="form-control" value="<?php echo $row['image'];?>" name="image" id="image"  />
                                            </div>
                                        </div>
                                    </div>
                                        <a href="consultProduct.php" class="btn btn-danger">Cancel</a>
                                        <input type="submit" name="btn-edit" class="btn btn-primary" value="Update">
