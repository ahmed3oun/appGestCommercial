...
$sql2="select * from products where category=\"Maquillage des levres\"";
...
<div id="logo">  <img src="src\img\taj.gif">
    <div id="search">
        ...
        <div class="slider fade">
           <img class="slides fade" src="src\img\lvv.jpg" style="width: 45%; border: 1px solid white;" />
          <img class="slides fade" src="src\img\mq.jpg" style="width: 45%; border: 1px solid white;"/>
                    <button class="btn" onclick="plusIndex(1)" id="btn2"> &#10095; </button>
          <div class="soinss">
              <strong>Maquillage des lèvres</strong>
              <p> Il est important de choisir la couleur de son rouge à lèvres avec soin. Les teintes très sombres sont déconseillées : elles marquent les rides, ternissent le teint et font ressortir les imperfections des dents. Tout ce qu'on cherche à éviter !</p>
        </div>
        </div>  
...
<footer class="footer-distributed "style="margin-top: 72%;">
