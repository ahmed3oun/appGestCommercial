...
$sql2="select * from products where category=\"Soin de cheuveux\"";
...
<div id="logo">  <img src="src\img\taj.gif">
    <div id="search">
        ...
        <div class="slider fade">
          <img class="slides fade" src="src/img/sch/ch.jpg" style="width: 45%; border: 1px solid white;"/>
          <img class="slides fade" src="src/img/sch/ch1.jpg" style="width: 45%; border: 1px solid white;"/>
                    <button class="btn" onclick="plusIndex(1)" id="btn2"> &#10095; </button>
          <div class="soinss">
              <strong>Soin des cheveux</strong>
              <p> Les soins des cheveux biologiques révèleront la beauté naturelle de vos cheveux. Nos soins capillaires naturels sont des traitements professionnels. Notre large choix de soins cosmétiques naturels pour les cheveux vous assure des soins adaptés à votre type de cheveux. Brillant, plein de vie, vos cheveux sont plus bio…</p>
          </div>
        </div>
    <div class="panierh1"style="margin-top: 2%;">NOS PRODUITS</div>
...
<footer class="footer-distributed" style="margin-top: 170%;">
