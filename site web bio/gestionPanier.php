...
$produit=mysqli_fetch_assoc($result2);
?>
<!DOCTYPE html>
<html>
<head>
...
<center>
    <section  class="container">
        ...
        <article class="well form-inline  ">
            ...
            <label class="col-lg-3">Identifiant</label> : <input type = "number" name = "id" style="width:400px" class="input-sm form-control" readonly value="'.$_GET['id'].'"></input><br><br>
            <label class="col-lg-3" >Quantité</label> : <input type = "number" name="qte" style="width:400px" value="1" class="input-sm form-control"></input><br><br>
            <label class="col-lg-3">Prix</label> : <input type = "number" name = "prix" readonly value="'.$produit['price'].'" style="width:400px" class="input-sm form-control"></input><br><br>
            <button class="btn btn-primary" type="submit" "><span class="glyphicon glyphicon-shopping-cart"></span> Ajouter au panier</button>
            <input class="btn btn-primary" type="button" onclick="javascript:history.back();" value="Revenir"> 
            </form>
        </article>
    </section>
 ...
 echo '<h1> Vous n\'avez pas de session , Connectez-vous d\'abord ou Inscrivez vous si vous n\'avez pas du compte  <a href="register.php" style="color: #00a400; font-family: \'Eras Bold ITC\';">cliquer ici pour s\'inscrire</a> </h1>';
}
?>
