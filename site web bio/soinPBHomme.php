...
$sql2="select * from products where category=\"Soin pour la barbe\"";
...
<div id="logo">  <img src="src\img\taj.gif">
    <div id="search">
        ...
        <div class="slider fade">
          <img class="slides fade" src="src\img\hm\hm.jpg" style="width: 45%; border: 1px solid white;"/>
          <img class="slides fade" src="src\img\hm\hm1.jpg" style="width: 45%; border: 1px solid white;"/>
                    <button class="btn" onclick="plusIndex(1)" id="btn2"> &#10095; </button>

                    
          <div class="soinss">
              <strong>Soins pour la barbe</strong>
              <p> Entretenir sa barbe est une affaire quotidienne si vous voulez une barbe disciplinée, belle et qui ne pique pas ! Si vous voulez une belle barbe, vous allez faire le même chemin que les femmes qui veulent de beaux cheveux : entretien, hydratation, taille et coiffage.

Le premier temps est le temps de la pousse ( il faudra au moins un mois avant d'avoir quelque chose qui ressemble à une vrai barbe, le plus souvent deux à trois mois). On peut aider la pousse mais il faut déjà en prendre le plus grand soin. Le soin commence par avoir une barbe propre sans utiliser de produit qui vont l'abîmer ( le poil de barbe est très fragile). Ensuite, on ne le dira jamais assez, une belle barbe est une barbe bien hydratée.</p>
          </div>
        </div>  
...
<footer class="footer-distributed"style="margin-top: 74%;">
