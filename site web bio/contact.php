...
?>
<div class="panierh1" style="margin-top: 4%;">Contacter Nous </div>    
<div class="register">
                ...
                <form action="action_page.php" method="post">
                    		...
                    		<label>message:</label>
                    		<textarea class="form_textarea" name="message" rows="" cols="" id='message'></textarea>
                          ...
                          <div class="container">
                            <button type="button" class="cancelb">Annuler</button>
                          </div>
                </form>
          </div>
