...
$sql2="select * from products where category=\"Maquillage des teints\"";
...
<div id="logo">  <img src="src\img\taj.gif">
    <div id="search">
        ...
        <div class="slider fade">
          <img class="slides fade" src="src\img\c.jpg" style="width: 45%; border: 1px solid white;"/>
          <img class="slides fade" src="src\img\cc.jpg" style="width: 45%; border: 1px solid white;" />
                    <button class="btn" onclick="plusIndex(1)" id="btn2"> &#10095; </button>
              <div class="soinss">
              <strong>Maquillage du teint</strong>
              <p> Le secret d'un maquillage parfait commence par la base, à savoir le maquillage du teint. Un teint rayonnant, pas d'imperfections et un visage structuré sont les basiques du maquillage. Fond de teint fluide, compact, poudre libre, correcteur de teint, le maquillage bio s'impose par sa qualité, à vous de le découvrir.</p>
        </div>
        </div>  
        
    <div class="panierh1" style="margin-top: 1%;">NOS PRODUITS</div>
...
<footer class="footer-distributed "style="margin-top: 90%;">
