...
$sql2="select * from products where category=\"Soin du visage pour homme\"";
...
<div id="logo">  <img src="src\img\taj.gif">
    <div id="search">
        ...
        <div class="header_navbar_menu">
         ...
         <li><a href="contact.html" class="active">Contact <i class="fa fa-angle-down"></i></li></a>
        </ul>
        </div>
        <div class="slider fade">
          ...
          <div class="soins">
              <strong>Soin du visage homme</strong>
              <p> Les cosmétiques biologiques pour homme répondent parfaitement aux besoins spécifiques de la peau de l’homme bio. Notre large choix de cosmétiques bio et naturels pour l’homme vous garantie de trouver un produit de haute qualité adapté à votre mode de vie et à vos besoin. Du rasage aux soins anti rides, l'homme bio trouvera toutes les cosmétiques indispensables pour l'homme bio. Pour conserver son capital beauté et sa masculinité soyez bio…</p>
          </div>
        </div>

        <div class="panierh1" style="margin-bottom: 5%;">NOS PRODUITS</div>
