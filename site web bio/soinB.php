...
$sql2="select * from products where category=\"Soin de bebe\"";
...
<div id="logo">  <img src="src\img\taj.gif">
    <div id="search">
        ...
        <div class="slider fade">
          <img class="slides fade" src="src\img\bb\bb1.jpg" style="width: 45%; border: 1px solid white;" />
          <img class="slides fade" src="src\img\bb\bb.jpg" style="width: 45%; border: 1px solid white;" />
                    <button class="btn" onclick="plusIndex(1)" id="btn2"> &#10095; </button>
          <div class="soins">
              <strong>Le soin de bébé</strong>
              <p> Nos bébés, nos enfants sont fragiles et sensibles. Pour en prendre soin, il faut des produits spécialement étudiés pour leurs peaux et leurs besoins. Tous nos produits pour bébés et enfants sont doux et certifiés bio pour ne leurs donner que le meilleur et éviter tous risques. Produits bébé bio, couches lavables, allaitement, grossesse, soin pour bébé, textile bambou et coton bio, biberons sans Bisphénol-A et sans phtalate.</p>
          </div>
        </div>  
    <div class="panierh1" style="margin-bottom: 4%;">NOS PRODUITS</div>
...
<footer class="footer-distributed" style="margin-top: 93%;">
