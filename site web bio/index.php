...
?>
    ...
    <div class="bxslider">
    <img  src="src\img\lili.jpg" />
    <img  src="src\img\88.png" />
    <img  src="src\img\slid.jpg" />
  ...
  <div class="about_us " ><h3 class="title">Bienvenue dans TAAJBIO</h3><br><br>
    <div class="center">
  <p><span class="subtitle" >Présentation</span></p>
  <div class="presentation"><p>TAAJBIO est une page Tunisien, specialiser dans la production et la commercialisation des<strong> huiles naturelles</strong>, <strong>savons</strong>,&nbsp;<strong>masques </strong>&nbsp;<strong>maquillages</strong>.</p>
  <p>Nos produits sont certifiés organiques et <strong class="green">100% naturels</strong>. 
  <p>Les <strong>produits</strong>TAAJBIO sont entièrement <strong class="green">pures et naturelles</strong>, elles sont obtenues par distillation complète par entrainement à la vapeur d’eau des plantes sauvages ou de plantes cultivées. TaajBio sont botaniquement et biochimiquement définies.</p></div>
</div>
