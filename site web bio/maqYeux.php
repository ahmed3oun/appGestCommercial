...
$sql2="select * from products where category=\"Maquillage des yeux\"";
...
<div id="logo">  <img src="src\img\taj.gif">
    <div id="search">
        ...
        <div class="slider fade">
          <img class="slides fade" src="src\img\cc.jpg" style="width: 45%; border: 1px solid white;" />
          <img class="slides fade" src="src\img\mqq.jpg" style="width: 45%; border: 1px solid white;"/>
                    <button class="btn" onclick="plusIndex(1)" id="btn2"> &#10095; </button>

          <div class="soinss">
              <strong>Maquillage des yeux</strong>
              <p> Le maquillage des yeux est important pour mettre en valeur votre regard, lui redonner éclat et intensité ! Les yeux et le regard sont les deux choses qui vous reflète le plus votre personnalité.
              toujours un maquillage ou une technique respectant la couleur de vos yeux et votre carnation pour révéler toute votre sensualité.</p>
        </div>
        </div>  
        
    <div class="panierh1" style="margin-top: 1%;margin-bottom: 5%;">NOS PRODUITS</div>
...
<footer class="footer-distributed "style="margin-top: 80%;">
